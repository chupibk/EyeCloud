...
public class GetImageVideo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String frameId = request.getParameter(Constants.TAG_FRAME_ID) == null ? "" : request.getParameter(Constants.TAG_FRAME_ID);        
        Collection collection = new ArrayList();
        
        String dir = getServletContext().getRealPath("") + Constants.UPLOAD_PATH + "/" + heatmapId + "/" + frameId + Constants.FRAME_TYPE;
        int result = Libs.checkFile(dir);
