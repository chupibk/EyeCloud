 ...
 * @author chung-pi
 */
@WebServlet(urlPatterns = {"/DRPCVideo"})
public class DRPCVideo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String result = "";
        try {
            result = client.execute("youtube_rendering", data);
        } catch (TException ex) {
            Logger.getLogger(DRPCVideo.class.getName()).log(Level.SEVERE, null, ex);
