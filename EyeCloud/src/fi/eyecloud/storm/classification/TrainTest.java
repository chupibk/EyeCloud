...
public class TrainTest {
	...
	@SuppressWarnings("serial")
	public static class SVM extends BaseBasicBolt{
	...
	public static void main(String[] args) throws AlreadyAliveException, InvalidTopologyException {
        ...
        if(args==null || args.length==0) {
            ...
            ReadTextFile data = new ReadTextFile("TrainTest/LauraTest.txt");
            String send = "";
            int count = 0;
            ...
            System.out.println("Output file: " + drpc.execute("TrainTest", send));
            System.out.println("Running time: " + (float)(System.currentTimeMillis() - start)/1000);
            System.out.println("Output file: " + drpc.execute("TrainTest", "1"));
            cluster.shutdown();
            drpc.shutdown();
        } else {
